                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="admin_name" name="admin_name" required="required" class="form-control col-md-7 col-xs-12"> </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="admin_add">ที่อยู่ผู้ดูแลระบบ<span class="required">:</span> </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="admin_add" name="admin_add" required="required" class="form-control col-md-7 col-xs-12"> </div>
                        </div>
                        ...
                        if(isset($_POST['submit']))
                        {
                            ...
                            $sql=" insert into `tb_admin`(`admin_name`, `admin_add`, `admin_tel`, `admin_username`, `admin_password`)";
                            $sql.=" values ('$admin_name','$admin_add','$admin_tel','$admin_username','$admin_password')";
